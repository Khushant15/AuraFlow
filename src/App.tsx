...
function AppContent() {
  ...
  useEffect(() => {
    ...
    if (isRunning || isPaused) {
      document.title = `${timeStr} - ${modeStr} | Aura Flow`;
    } else {
      document.title = 'Aura Flow';
    }
  ...
  return (
    <div className="animated-bg" style={{ minHeight: '100vh' }}>
      ...
      <main style={{ paddingLeft: isFocusMode ? '0' : '120px', transition: 'padding 0.4s ease', flex: 1 }}>
